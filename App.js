        		...
        		<View style={styles.divide}>
					...
					{/* input area */}
				  	<View style={styles.body}>
						...
						<View style={{padding:5}}>
							<TouchableOpacity style={styles.submit} onPress={()=>this.props.navigation.navigate("Main")}><Text style={{fontSize:25,textAlign:'center',fontWeight:'bold',color:'#ffffff'}}>Submit</Text></TouchableOpacity>
						</View>
          			</View>
        		</View>
